...
const Page3 = (props: propsInterface) => {
  ...
  return (
    ...
    >
      ...
      >
        <Flex onClick={() => setSelected(1)} cursor='pointer' border="1px" p="6" py="10" w="49%" rounded="md" borderColor={selected === 1 ? primaryColor : "blackAlpha.400"} color={selected === 1 ? primaryColor :"black"} flexDir="column" justify='start'>
            <FaUser size={25} />
        ...
        <Flex onClick={() => setSelected(2)} cursor='pointer' border="1px" p="6" py="10" w="49%" rounded="md" borderColor={selected === 2 ? primaryColor :"blackAlpha.400"} color={selected === 2 ? primaryColor :"black"} flexDir="column" justify='start'>
            <FaUser size={25} />
        ...
        <Button bg={primaryColor} mt="5" w="80%" color='white' _hover={{}} _active={{}}onClick={handleOnSubmit}>Create workspace</Button>
    </Flex>
  );
};
